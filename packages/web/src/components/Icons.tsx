 ...
 * All icons accept className, size (default 16px), and style.
 */
...
export const IconPlay = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconStop = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconSquare = IconStop;
...
export const IconMoreHorizontal = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconFolder = ({ size = 16, className }: IconProps) => (
  ...
  >
    <path
      d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.5l-2-2.3A1.8 1.8 0 0 0 9.1 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"
      fill="currentColor"
      fillOpacity="0.14"
      stroke="currentColor"
      strokeWidth="1.65"
...
export const IconFolderOpen = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.5l-2-2.3A1.8 1.8 0 0 0 9.1 3H4a2 2 0 0 0-2 2v13"
      stroke="currentColor"
      strokeWidth="1.65"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M2 11.5h18.6a1.5 1.5 0 0 1 1.45 1.9l-1.8 6.6a2 2 0 0 1-1.92 1.5H3.6a1.8 1.8 0 0 1-1.75-2.25L3.5 13a2 2 0 0 1 1.9-1.5Z"
      fill="currentColor"
      fillOpacity="0.22"
      stroke="currentColor"
      strokeWidth="1.65"
...
export const IconReact = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
...
export const IconCopyLayers = ({ size = 15, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconWrapText = ({ size = 15, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M8 13h5a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2H9" />
    <polyline points="11 15 9 17 11 19" />
  </svg>
);
...
export const IconHand = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconShield = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconShieldCheck = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    <path d="m9 12 2 2 4-4" strokeWidth={1.75} />
  </svg>
);

export const IconPlan = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M7 2.5v3" strokeWidth={1.75} />
    <path d="M12 2.5v3" strokeWidth={1.75} />
    <path d="M17 2.5v3" strokeWidth={1.75} />
    <path d="M8 10.5h8" />
    <path d="M8 14.5h8" />
  </svg>
);

export const IconShieldAlert = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    <line x1="12" y1="8" x2="12" y2="12.5" strokeWidth={1.8} />
    <line x1="12" y1="16" x2="12.01" y2="16" strokeWidth={2.2} />
  </svg>
);
...
export const IconMessagePlus = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconMessageCheck = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconHelpCircle = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconFilePlus = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconPin = ({ size = 16, className }: IconProps) => (
  ...
  >
    <path d="M12 17v5" />
    <path d="M9 2h6l-1 7h3l-5 8-5-8h3l-1-7z" />
  </svg>
);
...
export const IconGauge = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconExternalLink = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconArrowUpRight = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconCircleCheck = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** MCode official logo: dark rounded square with bold italic M */
export const IconMCode = ({ size = 25, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 32 32"
  ...
  >
    ...
    <rect
      ...
      strokeWidth="1.5"
    />
    <g transform="skewX(-10) translate(2.5, 0)">
      <path
        d="M5.5 24V8H10.2L13.8 16.2L17.4 8H22.1V24H18V14.8L15.1 21.6H12.5L9.6 14.8V24H5.5Z"
        fill="#FFFFFF"
      />
    </g>
  </svg>
...
export const IconFileCode = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconGitCommit = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconGitPullRequest = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconRotateCcw = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconMinus = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconPlusCircle = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconMaximize = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconCollapseAll = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconExpandAll = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconTerminalSquare = ({ size = 16, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconPrisma = ({ size = 16, className, style }: IconProps & { style?: React.CSSProperties }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    style={style}
  >
    <path d="M12 2 3.5 20.5a1 1 0 0 0 1.3 1.3L20.5 13.5 12 2Z" fill="rgba(16, 185, 129, 0.15)" stroke="#10b981" strokeWidth={1.75} />
    <path d="m12 2 8.5 11.5L12 18V2Z" fill="rgba(16, 185, 129, 0.25)" stroke="#10b981" strokeWidth={1.5} />
  </svg>
);


export const IconChevronsDown = ({ size = 16, className, style }: IconProps & { style?: React.CSSProperties }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconWand = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="m15 4 5 5" />
    <path d="m3 21 9-9" />
    <path d="m12.2 6.8 2-2a2.83 2.83 0 0 1 4 4l-2 2" />
    <path d="m9 15 2 2" />
    <path d="M19 2v3" />
    <path d="M22 5h-3" />
    <path d="M2 12h3" />
...
export const IconBot = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconPlug = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconCommandPrompt = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconAnchor = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconCalendar = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconFlame = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconBarChart = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconActivityPulse = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconBookOpen = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconThumbsUp = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconThumbsDown = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconFileReview = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconGithub = ({ size = 16, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
